    ...
    <div className="container mx-auto px-6 py-3">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-end w-full">
                <Link to="/cart" className="text-gray-600 focus:outline-none mx-4 sm:mx-0">Cart</Link>
        ...
        <nav  className="sm:flex sm:justify-center sm:items-center mt-4">
            <div className="flex flex-col sm:flex-row">
                ...
                <Link to="/login" className="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0">Login</Link>
        ...
        <div className="relative mt-6 max-w-lg mx-auto">
            ...
            <input className="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" placeholder="Search"></input>
        </div>
    </div>
</header>
        </>
